...
{ 1, 9, 9, 0, 2, 8, 0, 9 }      1, 2, 3     1 встречается 3 раза
0 встречается 2 раза            4, 6, 1     2 встречается 2 раз
1 встречается 1 раз             2, 1, 6     3 встречается 1 раз
2 встречается 1 раз                         4 встречается 1 раз
8 встречается 1 раз                         6 встречается 2 раза
